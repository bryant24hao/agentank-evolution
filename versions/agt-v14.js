function onIdle(me, enemy, game) {
  ...
  // v14: defensive — if enemy is aimed at us at close range, break alignment even when we can't fire
  if (enemyTank && enemyAimedAtMeClose(myPos, enemyTank, map)) {
    var defenseDodgeDir = directionTo(enemyTank.position, myPos);
    if (sidestep(me, myDir, myPos, defenseDodgeDir, map)) return;
  }
