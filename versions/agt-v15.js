function onIdle(me, enemy, game) {
  ...
  // v15 DIAGNOSTIC: probe whether globals persist across onIdle calls
  if (typeof __probe === 'undefined') __probe = 0;
  __probe++;
  if (__probe <= 8 && typeof me.speak === 'function') me.speak("p=" + __probe);
