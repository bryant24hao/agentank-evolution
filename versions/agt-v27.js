function onIdle(me, enemy, game) {
  ...
  if (enemyTank && canFireNow(me) && canShoot(myPos, enemyTank.position, map)) {
    ...
    // v27: chain turn+fire same onIdle — engine executes turn next frame, then fire frame after.
    // For 180° (opposite dir), need 2 turns; otherwise 1 turn.
    if (myDir === oppositeDirV27(aimDir)) {
      me.turn("right");
      me.turn("right");
    } else {
