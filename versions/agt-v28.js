function onIdle(me, enemy, game) {
  ...
  var pursueStar = !!game.star;  // star pursuit allows risky fallback
  // v9: try BFS avoiding enemy aimed-LOS tiles first
  var next = target && nextStep(myPos, target, map, enemyTank, enemy, true);
  // v28: only fall back through danger zones if we're chasing a STAR (reward worth it).
  //      For enemy chase, patrol instead — don't suicide-walk into their gun line.
